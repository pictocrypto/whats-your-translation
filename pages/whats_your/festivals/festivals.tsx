  ...
  return (
    <><div className={styles.heroVideoBackground}>
      <div className={styles.heroVideoBackgroundInner}>
        ...
        <h1 className={styles.heroTitle}>NFT Festival Party Access</h1>
        <p><h2 className={styles.heroSubtitleWhite}><center>Get a Picto Crpyto NFT for Festival access</center></h2></p>
        <NFTGrid
          data={data}
          isLoading={isLoading}
