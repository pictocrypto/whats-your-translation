...
export default function SaleInfo({ nft }: Props) {
  ...
  // This instance is created from the contract address (NFT_COLLECTION_ADDRESS_MEMBERSHIPS)
  ...
  const { register: registerAuction, handleSubmit: handleSubmitAuction } =
    useForm<AuctionFormData>({
      defaultValues: {
        nftContractAddress: NFT_COLLECTION_ADDRESS_MEMBERSHIPS,
    ...
    <>
      ...
      <div className={styles.saleInfoContainer} style={{ marginTop: -42 }}>
        ...
        >
          ...
          <Web3Button
            contractAddress={MARKETPLACE_ADDRESS_MEMBERSHIPS}
            action={async () => {
            ...
            onSuccess={(txResult) => {
              ...
              router.push(
                `/token/${NFT_COLLECTION_ADDRESS_MEMBERSHIPS}/${nft.metadata.id}`
              );
            }}
          >
