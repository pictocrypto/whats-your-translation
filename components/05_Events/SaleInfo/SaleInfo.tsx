...
export default function SaleInfo({ nft }: Props) {
  ...
  // This instance is created from the contract address (NFT_COLLECTION_ADDRESS_EVENTS)
  ...
  const { register: registerAuction, handleSubmit: handleSubmitAuction } =
    useForm<AuctionFormData>({
      defaultValues: {
        nftContractAddress: NFT_COLLECTION_ADDRESS_EVENTS,
  ...
  return (
    <>
      ...
      <div className={styles.saleInfoContainer} style={{ marginTop: -42 }}>
        ...
        {/*Above is where the auction code would go*/}
        ...
        >
          ...
          <Web3Button
            contractAddress={MARKETPLACE_ADDRESS_EVENTS}
            action={async () => {
            ...
            onSuccess={(txResult) => {
              ...
              router.push(
                `/token/${NFT_COLLECTION_ADDRESS_EVENTS}/${nft.metadata.id}`
              );
            }}
          >
        ...
        {/* Auction listing fields would go here*/}
